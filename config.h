...
#define NAVE_ROTACION_PASO (PI/30)
...
#define ASTEROIDES_CANT_INICIAL 4
#define ASTEROIDES_INCREMENTO 2
...
#define PUNTAJE_ASTEROIDE_CHICO 100
#define PUNTAJE_ASTEROIDE_MEDIANO 50
#define PUNTAJE_ASTEROIDE_GRANDE 20
